...
# Load .csv files
zip = "./data/data.zip"
accident = read_csv(archive_read(zip, file = "FARS2022NationalCSV/accident.csv"))
cevent = read_csv(archive_read(zip, file = "FARS2022NationalCSV/cevent.csv"))
crashrf = read_csv(archive_read(zip, file = "FARS2022NationalCSV/crashrf.csv"))
...
driverrf = read_csv(archive_read(zip, file = "FARS2022NationalCSV/driverrf.csv"))
drugs = read_csv(archive_read(zip, file = "FARS2022NationalCSV/drugs.csv"))
...
parkwork = read_csv(archive_read(zip, file = "FARS2022NationalCSV/parkwork.csv"))
pbtype = read_csv(archive_read(zip, file = "FARS2022NationalCSV/pbtype.csv"))
person = read_csv(archive_read(zip, file = "FARS2022NationalCSV/person.csv"))
...
vehicle = read_csv(archive_read(zip, file = "FARS2022NationalCSV/vehicle.csv"))
...
vision = read_csv(archive_read(zip, file = "FARS2022NationalCSV/vision.csv"))
...
weather = read_csv(archive_read(zip, file = "FARS2022NationalCSV/weather.csv"))
